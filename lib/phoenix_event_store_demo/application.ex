defmodule PhoenixEventStoreDemo.Application do
  ...
  def start(_type, _args) do
    ...
    opts = [strategy: :one_for_one, name: PhoenixEventStoreDemo.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    PhoenixEventStoreDemoWeb.Endpoint.config_change(changed, removed)
    :ok
  end
end
